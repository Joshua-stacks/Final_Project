    ...
    <Wrapper>
      <Content>
        <Digital>
          ...
          <MorNi>
            <Time>
              {moment(value).tz("America/Los_Angeles").format("h:mm:ss")}
            </Time>
            {moment(value).tz("America/Los_Angeles").format("A")}
          </MorNi>
          <Date>
            {moment(value).tz("America/Los_Angeles").format("MMMM Do YYYY")}
          </Date>
        </Digital>
      ...
      <Content>
        <Digital>
          ...
          <MorNi>
            <Time>{moment(value).format("h:mm:ss")}</Time>
      ...
      <Content>
        <Digital>
          ...
          <MorNi>
            <Time>{moment(value).tz("Europe/Zurich").format("h:mm:ss")}</Time>
            {moment(value).tz("Europe/Zurich").format("A")}
          </MorNi>
          <Date>
            {moment(value).tz("Europe/Zurich").format("MMMM Do YYYY")}
          </Date>
        </Digital>
      ...
      <Content>
        <Digital>
          ...
          <MorNi>
            <Time>{moment(value).tz("Asia/Tokyo").format("h:mm:ss")}</Time>
            {moment(value).tz("Asia/Tokyo").format("A")}
          </MorNi>
